      ...
      Box {
        Surface(
          ...
          Row(
            ...
            Icon(Icons.Default.ArrowDropDown, contentDescription = stringResource(R.string.select_thinking_level), modifier = Modifier.size(18.dp), tint = mobileTextTertiary)
          }
        }
