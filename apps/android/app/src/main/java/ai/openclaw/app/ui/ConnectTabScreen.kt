...
fun ConnectTabScreen(viewModel: MainViewModel) {
  ...
  if (pendingTrust != null) {
    ...
    AlertDialog(
      ...
      title = { Text(stringResource(R.string.trust_gateway_title), style = mobileHeadline, color = mobileText) },
      text = {
        Text(
    ...
    Surface(
      ...
      Row(
        ...
        Column(verticalArrangement = Arrangement.spacedBy(2.dp)) {
          ...
          Text(stringResource(R.string.setup_controls_desc), style = mobileCaption1, color = mobileTextSecondary)
        }
        Icon(
    ...
    AnimatedVisibility(visible = advancedOpen) {
      Surface(
        ...
        Column(
          ...
          Text(stringResource(R.string.run_these), style = mobileCallout, color = mobileTextSecondary)
          ...
          if (inputMode == ConnectInputMode.SetupCode) {
            Text(stringResource(R.string.setup_code_label), style = mobileCaption1.copy(fontWeight = FontWeight.SemiBold), color = mobileTextSecondary)
            OutlinedTextField(
              value = setupCode,
              onValueChange = {
                setupCode = it
            ...
            Text(stringResource(R.string.host_label), style = mobileCaption1.copy(fontWeight = FontWeight.SemiBold), color = mobileTextSecondary)
            OutlinedTextField(
              ...
              placeholder = { Text(stringResource(R.string.default_host), style = mobileBody, color = mobileTextTertiary) },
              modifier = Modifier.fillMaxWidth(),
              singleLine = true,
            ...
            Text(stringResource(R.string.token_label), style = mobileCaption1.copy(fontWeight = FontWeight.SemiBold), color = mobileTextSecondary)
            OutlinedTextField(
              value = gatewayToken,
              onValueChange = { viewModel.setGatewayToken(it) },
              placeholder = { Text(stringResource(R.string.token_hint), style = mobileBody, color = mobileTextTertiary) },
              modifier = Modifier.fillMaxWidth(),
              singleLine = true,
              keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Ascii),
              textStyle = mobileBody.copy(color = mobileText),
            ...
            Text(stringResource(R.string.password_label), style = mobileCaption1.copy(fontWeight = FontWeight.SemiBold), color = mobileTextSecondary)
            OutlinedTextField(
              value = passwordInput,
              onValueChange = { passwordInput = it },
              placeholder = { Text(stringResource(R.string.password_hint), style = mobileBody, color = mobileTextTertiary) },
              modifier = Modifier.fillMaxWidth(),
              singleLine = true,
              keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Ascii),
              textStyle = mobileBody.copy(color = mobileText),
